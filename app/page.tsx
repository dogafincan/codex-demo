...
export default function HomePage() {
		...
		setState((prev) => {
			...
			return {
				...
				timeLeft: minutesToSeconds(
					sessionDurationMinutes(sessionType, settings),
				),
	...
	const workDurationId = React.useId();
	const shortBreakId = React.useId();
							...
							<DialogContent className="max-h-[85vh] overflow-y-auto">
								<form className="space-y-6" onSubmit={handleSettingsSubmit}>
									<DialogHeader>
										...
										<DialogDescription>
											Customise your focus and recovery cycles. Changes persist
											to this device.
										</DialogDescription>
									</DialogHeader>
									...
									<div className="grid gap-4 sm:grid-cols-2">
										...
										<SettingField
											...
											onChange={(value) =>
												setPendingSettings((prev) => ({
													...prev,
													longBreakInterval: Math.max(1, value),
												}))
											}
										/>
									</div>
						...
						<Card className="relative overflow-hidden">
							<CardHeader className="flex flex-row items-center justify-between">
								<div>
									...
									<CardDescription>
										{SESSION_DESCRIPTIONS[state.sessionType]}
									</CardDescription>
								</div>
						...
						<div className="grid gap-6">
								...
								<CardContent className="space-y-4 text-sm">
									...
									<div className="space-y-2">
										...
										<ul className="space-y-1 text-sm text-zinc-500 dark:text-zinc-400">
											<li>
												• Long break after {settings.longBreakInterval} focus
												blocks
											</li>
											<li>
												• {settings.workDuration}′ focus |{" "}
												{settings.shortBreakDuration}′ short breaks
											</li>
							...
							<Card>
								<CardHeader>
									...
									<CardDescription>
										Last focus blocks you have completed
									</CardDescription>
								</CardHeader>
								<CardContent>
		...
		<div className="grid gap-6 lg:grid-cols-2">
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Your last seven days of focused effort
					</CardDescription>
				</CardHeader>
