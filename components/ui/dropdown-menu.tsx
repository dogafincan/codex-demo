...
export function DropdownMenuTrigger({
	...
	const childRef = React.useMemo<React.Ref<HTMLElement> | undefined>(() => {
		if (!child) return undefined;
		return (child as React.ReactElement<{ ref?: React.Ref<HTMLElement> }>).props
	...
	React.useEffect(() => {
		...
		return () => {
			if (triggerRef.current === triggerElement) {
	...
	return (
		<button
			type="button"
			ref={handleTriggerRef as React.RefCallback<HTMLButtonElement>}
			onClick={toggle}
		>
			{children}
		</button>
